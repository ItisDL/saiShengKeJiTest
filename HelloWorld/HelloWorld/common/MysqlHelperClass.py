...
import pymysql
import sys
from HelloWorld.HelloWorld.config import db_config


class pythonMysqlHepler:
    def __init__(self, host=db_config.my_host,
                 user=db_config.my_user,
                 password=db_config.my_password,
                 db=db_config.my_db,
                 port=db_config.my_port,
                 charset=db_config.my_charset):
        self.host = host
        self.user = user
